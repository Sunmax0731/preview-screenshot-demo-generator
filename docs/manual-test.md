...
- 作業ディレクトリ: `D:\AI\UnityEditor\preview-screenshot-demo-generator`
...
```powershell
cd D:\AI\UnityEditor\preview-screenshot-demo-generator
npm test
npm start
```
...
- docs ZIP が `dist/preview-screenshot-demo-generator-docs.zip` に存在する。
