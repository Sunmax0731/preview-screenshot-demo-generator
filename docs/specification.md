...
`samples/sample-input.json` または同等の JSON を入力する。各 item は `id`、`title`、`source`、`scene`、`outputPreset`、`owner`、`acceptance` を必須項目とする。
...
- `dist/preview-screenshot-demo-generator-docs.zip`: ドキュメント一式
